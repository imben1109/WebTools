...
var react_router_1 = __webpack_require__(75);
var PreparedStatementCombinerComponent_1 = __webpack_require__(76);
var App = /** @class */function (_super) {
    ...
    App.prototype.render = function () {
        return React.createElement(react_router_dom_1.MemoryRouter, null, React.createElement("div", null, React.createElement("h1", null, "Hello World"), React.createElement("ul", null, React.createElement("li", null, React.createElement(react_router_dom_1.Link, { to: "/" }, "PreparedStatementCombiner"))), React.createElement(react_router_1.Route, { exact: true, path: "/", component: PreparedStatementCombinerComponent_1.PreparedStatementCombinerComponent })));
    };
    return App;
}(React.Component);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var PreparedStatementCombinerHelper_1 = __webpack_require__(77);
/**
 * React Component of Prepared Statement
 */
var PreparedStatementCombinerComponent = /** @class */function (_super) {
    __extends(PreparedStatementCombinerComponent, _super);
    function PreparedStatementCombinerComponent(props) {
    ...
    PreparedStatementCombinerComponent.prototype.onCombine = function (event) {
        console.log(this.state.preparedStatement);
        console.log(this.state.bindValues);
        var combinedSql = PreparedStatementCombinerHelper_1.PreparedStatementCombinerHelper.getCombinedSql(this.state.preparedStatement, this.state.bindValues);
        this.setState({
            combinedSql: combinedSql
        });
    };
    PreparedStatementCombinerComponent.prototype.updatePreparedStatement = function (event) {
        this.setState({
            preparedStatement: event.target.value
        });
    };
    PreparedStatementCombinerComponent.prototype.updateBindValues = function (event) {
        this.setState({
            bindValues: event.target.value
        });
    };
    PreparedStatementCombinerComponent.prototype.render = function () {
        return React.createElement("div", null, React.createElement("div", null, React.createElement("textarea", { value: this.state.preparedStatement, onChange: this.updatePreparedStatement.bind(this) }), React.createElement("textarea", { value: this.state.bindValues, onChange: this.updateBindValues.bind(this) }), React.createElement("button", { onClick: this.onCombine.bind(this) }, "Combine")), React.createElement("div", null, React.createElement("textarea", { value: this.state.combinedSql, disabled: true })));
    };
    return PreparedStatementCombinerComponent;
}(React.Component);
exports.PreparedStatementCombinerComponent = PreparedStatementCombinerComponent;
 ...
 */
var PreparedStatementCombinerHelper = {
    /**
     * Get Bind Value List
     *
     * @param bindValues
...
exports.PreparedStatementCombinerHelper = PreparedStatementCombinerHelper;
